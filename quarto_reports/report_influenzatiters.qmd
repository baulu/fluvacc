...
--\> base_log2 vs. log2 first has the highest correlation coefficient for all 3 strains. log2 or log10 gives same results. Seems most appropriate to use this for linear regressions.

# Assessing Linear Regression Models & Residuals

QQ plots from multivariant regression models for all strains - comparing log2 and log2 first (predictors: age, sex, group, baseline titers)
```{r}
sumplot_qq_uni
```
